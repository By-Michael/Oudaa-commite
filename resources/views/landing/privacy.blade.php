...
@section('title', 'Privacy Policy — Oudaa')
...
<header class="page-header">
    <div class="container">
      ...
      <div class="breadcrumb-custom">
        <a href="{{ route('landing.index') }}">Home</a> <span>/</span> <span class="active">Privacy Policy</span>
      </div>
    </div>
  </header>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-9 reveal">
          ...
          <p>This Privacy Policy explains how Oudaa ("Oudaa," "we," "us") handles information when a committee creates a platform and uses it to manage its community. By creating a platform or using Oudaa, you agree to the practices described here.</p>

          <h3 class="mt-5 mb-3">1. Who this applies to</h3>
          ...
          <ul class="list-check mb-4">
            <li><i class="bi bi-check"></i><div><strong class="text-navy">Committee members</strong> — people who sign up, create a platform, and log in to manage it.</div></li>
            <li><i class="bi bi-check"></i><div><strong class="text-navy">Residents</strong> — people whose records a committee enters into the platform. Residents do not create their own accounts or log in; their information is entered and managed by the committee.</div></li>
          </ul>

          <h3 class="mt-5 mb-3">2. What we collect</h3>
          <p><strong class="text-navy">From committee members (account holders):</strong> name, email address, password (stored hashed, never in plain text), and the community/platform details provided during signup (community name, chosen subdomain, community type).</p>
          <p><strong class="text-navy">Resident records entered by a committee:</strong> name, ID number, unit and, where applicable, block number, contact details, and occupancy status (owner or tenant). This data belongs to the committee that entered it — Oudaa does not collect it directly from residents.</p>
          <p><strong class="text-navy">Financial records:</strong> fees, payments, fund balances, projects and expenses that a committee logs. Oudaa does not process card payments and does not collect or store payment card numbers. Payments recorded in the platform reflect fees collected offline (cash, bank transfer, or however the committee actually collects money) — Oudaa is a record-keeping tool for that activity, not a payment processor.</p>
          ...
          <ul class="list-check mb-4">
            ...
            <li><i class="bi bi-check"></i><div>To send account-related emails — password setup links, login-related notices, and replies to inquiries submitted through the Contact page.</div></li>
            <li><i class="bi bi-check"></i><div>To maintain the security, integrity and audit trail of records within a platform.</div></li>
            <li><i class="bi bi-check"></i><div>To respond to support requests.</div></li>
          </ul>
          <p>We do not sell resident or committee data, and we do not use it for advertising.</p>

          <h3 class="mt-5 mb-3">5. Who can see your data</h3>
          ...
          <h3 class="mt-5 mb-3">6. Data retention</h3>
          ...
          <h3 class="mt-5 mb-3">7. Your rights</h3>
          ...
          <h3 class="mt-5 mb-3">10. Governing law</h3>
          <p>This policy is governed by the laws of Ethiopia.</p>

          <h3 class="mt-5 mb-3">11. Contact us</h3>
          <p>Questions about this policy or your data can be sent to <a href="mailto:m7020322@gmail.com" class="text-primary-custom fw-semibold text-decoration-none">m7020322@gmail.com</a> or <a href="tel:+251973069687" class="text-primary-custom fw-semibold text-decoration-none">+251 973 069 687</a>.</p>
