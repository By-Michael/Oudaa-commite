  ...
  <header class="page-header">
    <div class="container">
      ...
      <div class="breadcrumb-custom">
        <a href="{{ route('landing.index') }}">Home</a> <span>/</span> <span class="active">About</span>
      </div>
    </div>
  </header>
    ...
    <div class="container">
      <div class="row align-items-center g-5">
        ...
        <div class="col-lg-6 reveal">
          ...
          <p class="section-subtitle mb-3">Most residential communities — whether it's a small group of houses or a full apartment building — are still run on a patchwork of spreadsheets, paper receipts and group chats. It works, until a fund balance doesn't add up or nobody remembers who paid last month's fee.</p>
          <p class="mb-4">Oudaa exists to fix that: one platform where a committee can manage residents, fees, payments, funds, projects and expenses, with every number in one place that the whole committee can trust.</p>
          <div class="row g-3">
            <div class="col-6">
              <div class="d-flex align-items-center gap-3">
                <div class="icon-box icon-box-primary"><i class="bi bi-shield-lock"></i></div>
                <div><strong class="text-navy d-block">Private by design</strong><small class="text-slate">Your data, isolated per community</small></div>
              </div>
            </div>
            <div class="col-6">
              <div class="d-flex align-items-center gap-3">
                <div class="icon-box icon-box-success"><i class="bi bi-lightning-charge"></i></div>
                <div><strong class="text-navy d-block">Ready in minutes</strong><small class="text-slate">No setup calls required</small></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row g-4">
        <div class="col-md-6 col-lg-3 reveal">
          <div class="card-premium text-center">
            ...
            <h3 class="card-title">Simple over feature-heavy</h3>
        ...
        <div class="col-md-6 col-lg-3 reveal">
          <div class="card-premium text-center">
            ...
            <h3 class="card-title">One shared source of truth</h3>
        ...
        <div class="col-md-6 col-lg-3 reveal">
          <div class="card-premium text-center">
            ...
            <h3 class="card-title">Your community's data is yours</h3>
        ...
        <div class="col-md-6 col-lg-3 reveal">
          <div class="card-premium text-center">
            ...
            <h3 class="card-title">Built to grow with you</h3>
    ...
    <div class="container">
      <div class="cta-section reveal">
        <div class="row align-items-center">
          <div class="col-lg-8">
            <h2 class="mb-2">See it for yourself</h2>
