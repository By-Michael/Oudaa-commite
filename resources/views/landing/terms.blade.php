    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-9 reveal">
          ...
          <p>Questions about these Terms can be sent to <a href="mailto:m7020322@gmail.com" class="text-primary-custom fw-semibold text-decoration-none">m7020322@gmail.com</a> {{ __('or') }} <a href="tel:+251973069687" class="text-primary-custom fw-semibold text-decoration-none">+251 973 069 687</a>.</p>
