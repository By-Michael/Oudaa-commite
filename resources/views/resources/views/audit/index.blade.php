...
<div class="toolbar">
    ...
    <span class="muted">Append-only — nothing here can be edited or removed.</span>
</div>
...
<div class="panel">
    <div class="panel-body" style="padding:0;">
        ...
        @else
            <table>
                <thead><tr><th>When</th><th>Committee Member</th><th>Action</th><th>Type</th><th>Details</th></tr></thead>
                <tbody>
                @foreach ($logs as $log)
                    <tr>
