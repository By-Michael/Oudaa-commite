...
<header class="page-header">
    <div class="container">
      ...
      <div class="breadcrumb-custom">
        <a href="{{ route('landing.index') }}">Home</a> <span>/</span> <span class="active">Features</span>
      </div>
    </div>
  </header>
    ...
    <div class="container">
      <div class="row section-header justify-content-center text-center">
        <div class="col-lg-7 reveal">
          <span class="eyebrow">One platform, six essentials</span>
          <h2 class="section-title">Everything a committee actually uses</h2>
          <p class="section-subtitle mx-auto">No bloated features you'll never touch — just the parts of running a community that used to live across spreadsheets, group chats and paper folders.</p>
        </div>
      </div>
      <div class="row g-4">
        ...
        <div class="col-md-6 col-lg-4 reveal">
          <div class="card-premium">
            ...
            <p class="mb-3">Set up recurring or one-off fees for the whole community, and see at a glance who's paid and who's still due.</p>
        ...
        <div class="col-md-6 col-lg-4 reveal">
          <div class="card-premium">
            ...
            <p class="mb-3">Record every payment against the resident and fee it belongs to — a clean, auditable paper trail with no guesswork.</p>
            <a href="{{ route('landing.service-details', 'payments') }}" class="card-link-arrow">Learn more <i class="bi bi-arrow-right"></i></a>
          </div>
        </div>
        <div class="col-md-6 col-lg-4 reveal">
          <div class="card-premium">
            ...
            <p class="mb-3">Split community money into separate funds — maintenance, reserve, events, anything — so balances never blur together.</p>
        ...
        <div class="col-md-6 col-lg-4 reveal">
          <div class="card-premium">
            ...
            <p class="mb-3">Plan community projects — repaving, repairs, upgrades — against a fund's budget, and track progress from planned to complete.</p>
        ...
        <div class="col-md-6 col-lg-4 reveal">
          <div class="card-premium">
            ...
            <p class="mb-3">Log every outgoing cost against the right project or fund, so the committee always knows exactly where the money went.</p>
            <a href="{{ route('landing.service-details', 'expenses') }}" class="card-link-arrow">Learn more <i class="bi bi-arrow-right"></i></a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row align-items-center g-5">
        <div class="col-lg-6 reveal">
          ...
          <h2 class="section-title">Any community, big or small</h2>
          ...
          <ul class="list-check">
            <li><i class="bi bi-check"></i><div><strong class="text-navy">Normal communities</strong> — houses and villas, organized by unit.</div></li>
            <li><i class="bi bi-check"></i><div><strong class="text-navy">Condos &amp; apartment buildings</strong> — adds block numbers for every resident.</div></li>
            <li><i class="bi bi-check"></i><div><strong class="text-navy">Multiple committee members</strong> — each with their own login, so every action is attributable.</div></li>
          </ul>
        </div>
        <div class="col-lg-6 reveal">
          ...
          <div class="accordion accordion-custom" id="servicesFaq">
            <div class="accordion-item">
              <h2 class="accordion-header">
                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#faq1">How much does it cost?</button>
              </h2>
            ...
            <div class="accordion-item">
              <h2 class="accordion-header">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq2">How long does setup take?</button>
              </h2>
            ...
            <div class="accordion-item">
              <h2 class="accordion-header">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq3">Can residents log in themselves?</button>
              </h2>
              <div id="faq3" class="accordion-collapse collapse" data-bs-parent="#servicesFaq">
                <div class="accordion-body">Not currently — Oudaa is built for the committee to manage records on residents' behalf. Residents don't need their own account.</div>
              </div>
            </div>
            <div class="accordion-item">
              <h2 class="accordion-header">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq4">Is our community's data separate from others?</button>
              </h2>
              <div id="faq4" class="accordion-collapse collapse" data-bs-parent="#servicesFaq">
                <div class="accordion-body">Yes — every community gets its own private database. Nothing is shared between communities.</div>
              </div>
            </div>
          </div>
        </div>
