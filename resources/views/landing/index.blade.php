          ...
          <div class="hero-visual position-relative mx-auto" style="max-width: 480px;">
            <div class="hero-mock-card">
              <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <span class="badge-soft">{{ __('Dashboard') }}</span>
              </div>
    ...
    <div class="container">
      <div class="row section-header align-items-end">
        ...
        <div class="col-lg-5 text-lg-end mt-3 mt-lg-0 reveal">
          <a href="{{ route('landing.services') }}" class="card-link-arrow">{{ __('See all features') }} <i class="bi bi-arrow-right"></i></a>
        </div>
      </div>
      <div class="row g-4">
    ...
    <div class="container">
      <div class="cta-section reveal">
        <div class="row align-items-center">
          <div class="col-lg-8">
            <h2 class="mb-2">{{ __('Ready to get your community organized?') }}</h2>
            <p class="mb-0 fs-5">{{ __('Create your platform for free — no credit card, no sales call.') }}</p>
          </div>
